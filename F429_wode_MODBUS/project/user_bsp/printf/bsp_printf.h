...
#define user_printf_info(format, ...)                      printf("[main]info:" format "\r\n", ##__VA_ARGS__)
#define user_printf_debug(format, ...)                     printf("[main]debug:" format "\r\n", ##__VA_ARGS__)
#define user_printf_error(format, ...)                     printf("[main]error:" format "\r\n",##__VA_ARGS__)
...
#define user_printf_info(format, ...)
#define user_printf_debug(format, ...)
#define user_printf_error(format, ...)
